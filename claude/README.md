...
| --------- | ----- | ----- |
| **Skills**  | 58 | conventions + utilities (ticket writers, C#/.NET, Angular/TS, SQL, `main-stack-agents-flow` per-domain orchestration + `cross-stack-agents-flow` cross-domain routing, `project-quality-loop` + `architecture-quality-loop` review loops) - `npx skills add … --agent claude-code` |
