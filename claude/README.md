...
| --------- | ----- | ----- |
| **Skills**  | 54 | conventions + utilities (ticket writers, C#/.NET, Angular/TS, SQL, `domain-build` per-domain orchestration + `subagent-flow` cross-domain routing) - `npx skills add … --agent claude-code` |
