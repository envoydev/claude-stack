...
| --------- | ----- | ----- |
| **Skills**  | 63 | conventions + utilities (ticket writers, C#/.NET, Angular/TS, SQL, `main-stack-agents-flow` per-domain orchestration + `project-task-flow` cross-domain routing, `project-quality-loop` + `project-architecture-quality-loop` review loops) - `npx skills add … --agent claude-code` |
