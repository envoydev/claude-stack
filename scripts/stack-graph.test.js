...
test('the hook catalog carries the installer HOOKS block basenames', () => {
    assert.deepStrictEqual(graph.catalog.hooks,
        ['docs-session', 'guard-answer-length', 'guard-catastrophic-rm', 'guard-config-protection', 'guard-cross-project-write', 'guard-fresh-session-start', 'guard-protected-force-push', 'guard-read-whole-file', 'guard-secret-value', 'guard-stop-contract', 'guard-unapproved-dispatch', 'guard-ungated-commit', 'instrument-tool-usage', 'memory-session'],
