...
test('the hook catalog carries the installer HOOKS block basenames', () => {
    assert.deepStrictEqual(graph.catalog.hooks,
        ['guard-catastrophic-rm', 'guard-protected-force-push', 'guard-read-whole-file', 'guard-stop-contract', 'guard-unapproved-dispatch', 'guard-ungated-commit', 'instrument-tool-usage'],
