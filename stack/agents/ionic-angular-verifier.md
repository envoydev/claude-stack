...
## Conventions
- `ionic`, `angular-conventions`, `angular-styling`, `typescript`, and `angular-testing` are preloaded - judge the diff against them directly (suite quality and the jsdom boundary against the testing hub), not recall.
