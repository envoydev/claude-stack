...
- The dispatch may carry a focus hint (the coverage capture sends the module's uncovered list with a testability focus) - weight the smells/violations part toward it; the five-part verdict shape holds.
