...
Patterns for when row-level security is the tenancy mechanism (policy *basics* - creating and enabling policies, least-privilege logins - are the data-layer security skill's):
