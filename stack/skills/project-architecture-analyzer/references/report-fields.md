...
| `Write gate:` | the answer to the pre-write AskUserQuestion, verbatim - or the reason the run skipped the ask (`first capture - no docs to replace`, `zero drift - nothing written`) | the ask before the first byte |
