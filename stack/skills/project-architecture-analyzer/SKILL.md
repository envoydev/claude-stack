...
Replace `<docs-path>` with the LITERAL resolved root this capture wrote under (`CLAUDE_DOCS_PATH`
from `.claude/settings.json` env, default `.claude/docs`) - the generated rule is a deterministic
