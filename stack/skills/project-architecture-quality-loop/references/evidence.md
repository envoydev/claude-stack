...
- **a verdict line without the ask's receipt is an unfinished step 3** - measured: a continue-ask fired without the fresh-session option and round 2 ran inside the same 411k-ctx/msg chat
