...
- No marker comments flagging a deliberate simplification in code or output - its ceiling and upgrade path goes in the report or summary, never into a code comment.
